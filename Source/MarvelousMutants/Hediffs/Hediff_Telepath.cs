...
{
    public class Hediff_Telepath : Hediff_Power, IXpUser
    {
        ...
        private void AddAbilities()
        {
            foreach (var ability in DefDatabase<AbilityDef>.AllDefs.Where(ab =>
                (ab.abilityClass == typeof(Power_Telepathic) ||
                 ab.abilityClass.IsSubclassOf(typeof(Power_Telepathic))) &&
        ...
        {
            var toRemove = pawn.abilities.abilities.Where(ab => ab is Power_Telepathic).ToList();
